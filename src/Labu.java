...
public class Labu extends Tanaman implements Drawable{

	//konstruktor
	{
		this.setSpriteManager(new SpriteManager("./res/Labu.png", 1, 6));
	}
	...
	Labu(Stage s, String nama) {
        super(s);
        this.nama = nama;
    }

	Labu(Stage s, String nama, Point lokasi){
		super(s, nama, lokasi);
		//muncul gambar biji
