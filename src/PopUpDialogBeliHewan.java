...
public class PopUpDialogBeliHewan extends PopUp {
    ...
    
    {
            ...
            try {
                    this.dialog = ImageIO.read(new File("./res/BeliTernak1.png"));
    ...
    public PopUpDialogBeliHewan(){
            super();
            this.pemain = Game.getPemain();
    }

    public PopUpDialogBeliHewan(PopUpManager popUpManager, Game game){
            super(popUpManager, game);
            this.pemain = Game.getPemain();
    }

    public PopUpDialogBeliHewan(PopUpManager popUpManager, Game game, int width, int height){
