...
public class PopUpDialogBeliBiji extends PopUp{
    ...
    
    {
            ...
            try {
                    this.dialog = ImageIO.read(new File("./res/BeliBiji1.png"));
    ...
    public PopUpDialogBeliBiji(){
            super();
            this.pemain = Game.getPemain();
    }

    public PopUpDialogBeliBiji(PopUpManager popUpManager, Game game){
            super(popUpManager, game);
            this.pemain = Game.getPemain();
    }

    public PopUpDialogBeliBiji(PopUpManager popUpManager, Game game, int width, int height){
