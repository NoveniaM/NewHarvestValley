...
public class PopUpDialogJualHasilPanen extends PopUp{
    ...
    
    {
            ...
            try {
                    this.dialog = ImageIO.read(new File("./res/JualPanen1.png"));
    ...
    public PopUpDialogJualHasilPanen(){
            super();
            this.pemain = Game.getPemain();
    }

    public PopUpDialogJualHasilPanen(PopUpManager popUpManager, Game game){
            super(popUpManager, game);
            this.pemain = Game.getPemain();
    }

    public PopUpDialogJualHasilPanen(PopUpManager popUpManager, Game game, int width, int height){
