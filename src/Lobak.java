...
public class Lobak extends Tanaman implements Drawable{

	//konstruktor
	{
		this.setSpriteManager(new SpriteManager("./res/Lobak.png", 1, 6));
	}
	...
	Lobak(Stage s, String nama) {
        super(s);
        this.nama = nama;
    }

	Lobak(Stage s, String nama, Point lokasi){
		super(s, nama, lokasi);
		//muncul gambar biji
