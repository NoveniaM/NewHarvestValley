...
public class Kol extends Tanaman implements Drawable{

	//konstruktor
	{
		this.setSpriteManager(new SpriteManager("./res/Kol.png", 1, 6));
	}
	...
	Kol(Stage s, String nama) {
        super(s);
        this.nama = nama;
    }

	Kol(Stage s, String nama, Point lokasi){
		super(s, nama, lokasi);
		//muncul gambar biji
